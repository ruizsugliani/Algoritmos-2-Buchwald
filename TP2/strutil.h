...
/*
   Elimina el salto de linea para poder almacenar todos los usuarios.
   Caso borde que al final de la linea se almacenaba el usuario con /n y lo tomaba como diferente usuario.
*/
